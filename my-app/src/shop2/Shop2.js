...
import "./Shop2.css"
import img from "./shop2 img/ik.webp"
import img1 from "./shop2 img/ev.jpeg"
import img2 from "./shop2 img/kl.jpeg"
import img3 from "./shop2 img/ru.jpeg"
import img4 from "./shop2 img/st.jpeg"
import img5 from "./shop2 img/cj.jpeg"
import img6 from "./shop2 img/zv.jpeg"
import img7 from "./shop2 img/cp.jpeg"
        ...
        <div>
            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-sm-12 col-md-6 col-lg-6'><button className=' btn btn-light fs-5 ps-3 pe-3'><i class="fa-solid fa-arrow-right-arrow-left me-3 "></i>
                        Hide
                        Filters</button></div>
                    <div className='col-sm-12 col-md-6 col-lg-6 mk d-flex align-items-center fs-5 justify-content-end'>Showing all 7 results <div class="dropdown">
            ...
            <div className='container mt-5 mb-5  '>
                <div className='row'><div className='col-sm-12 col-md-3 col-lg-3 '><h6 className='text-secondary'>Filter By Price</h6><input className='form-range w-100' type='range' />
                    <div className='d-flex justify-content-between mt-3 pb-4'><p>Price: ₹1,490 — ₹1,800</p><button className='btn btn-light fw-bold ps-4 pe-4'>Filter</button></div><h5 className='text-secondary mt-5'>Product Categories</h5><a className='d-flex justify-content-between text-decoration-none mt-4 text-dark nm' href='#'><h5 className='fw-bold tx'>Hoodies & sweatshirts</h5><div className=' cr'>7</div></a><a className='d-flex justify-content-between text-decoration-none mt-2 text-dark nm' href='#'><h5 className='fw-bold tx'>T-Shirts</h5><div className='rc'>2</div></a><a className='d-flex justify-content-between text-decoration-none mt-2 text-dark nm' href='#'><h5 className='fw-bold tx'>Uncategorized</h5><div className='rc'>1</div></a>
                </div>
                    <div className='col-sm-12 col-md-9 col-lg-9 mk'><div className='row'>
                        <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                            ...
                            <div className='card-body p-4 pb-5'>   <h6>


                                “Haters”- Slogan Hoodie (Light Green)
                        ...
                        <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                            <div className='card-header br' style={{ backgroundImage: `url(${img2})`, }}><button className='btn btn-primary mt-3 ps-3 pe-3'>Sale!</button></div>
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                                <div className='card-header br' style={{ backgroundImage: `url(${img3})`, }}><button className='btn btn-primary mt-3 ps-3 pe-3'>Sale!</button></div>
                                <div className='card-body p-4 pb-5'>
                                    <h6>


                                        Chore Haryana Aale – Black
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                                <div className='card-header br' style={{ backgroundImage: `url(${img4})`, }}><button className='btn btn-primary mt-3 ps-3 pe-3'>Sale!</button></div>
                                <div className='card-body p-4 pb-5'>
                                    <h6>
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                                <div className='card-header br' style={{ backgroundImage: `url(${img5})`, }}></div>
                                <div className='card-body p-4 pb-5'>
                                    <h6>


                                        SANATANI Hoodie (Black)
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                                <div className='card-header br' style={{ backgroundImage: `url(${img6})`, }}><button className='btn btn-primary mt-3 ps-3 pe-3'>Sale!</button></div>
                                <div className='card-body p-4 pb-5'>
                                    <h6>
                            ...
                            <div className='col-sm-12 col-md-6 col-lg-6'><div className=' sc border-0'>
                                <div className='card-header br' style={{ backgroundImage: `url(${img7})`, }}></div>
                                <div className='card-body p-4 pb-5'>
                                    <h6>



                                        SYSTUMM TYPO- Hoodie (Green)
